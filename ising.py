# -*- coding: utf-8 -*-
"""
Created on Thu May 19 11:15:47 2022
...
size = 150                           # number of sites in a lattice row (change if desired)
squareWidth = 5                    # width of one site in pixels (change if desired)
...
tSlider = Tkinter.Scale(controlFrame, from_=0.0, to=100.0, resolution=0.01, length=120, orient="horizontal")
