...
p1=double_pendulum(m1=40, m2=10, L1=4, L2=5, theta1=np.pi, theta2=np.pi, theta1_dot=2-0.01, theta2_dot=-2-0.01)
p2=double_pendulum(m1=40, m2=10, L1=4, L2=5, theta1=np.pi, theta2=np.pi, theta1_dot=2, theta2_dot=-2)
#p3=double_pendulum(m1=10, m2=20, L1=3, L2=4, theta1=np.pi/6, theta2=np.pi, theta1_dot=-0.0, theta2_dot=0)
...
ani = animation.FuncAnimation(fig, animate, range(1, len(states[0])),
                              interval=dt*50, init_func=init, repeat=False)
plt.show()
#ani.save("D:\\Codes\\matplotlib animation\\multiple double pendulum 1.gif",fps=150, writer= "pillow", dpi=300)