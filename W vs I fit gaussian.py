...
for i in range(2):
    ...
    plt.plot(w1[minval:maxval],I1[minval:maxval],label='s1',linewidth=lw) 
    plt.plot(w2[minval:maxval],I2[minval:maxval],label='s2',linewidth=lw)
    plt.plot(w3[minval:maxval],I3[minval:maxval],label='s3',linewidth=lw)
    plt.plot(w4[minval:maxval],I4[minval:maxval],label='s4',linewidth=lw)
    plt.plot(w5[minval:maxval],I5[minval:maxval],label='s5',linewidth=lw)
    plt.plot(w6[minval:maxval],I6[minval:maxval],label='s6',linewidth=lw)
    plt.plot(w7[minval:maxval],I7[minval:maxval],label='s7',linewidth=lw)
    plt.plot(w8[minval:maxval],I8[minval:maxval],label='s8',linewidth=lw)
    plt.plot(w9[minval:maxval],I9[minval:maxval],label='s9',linewidth=lw)
    plt.plot(w10[minval:maxval],I10[minval:maxval],label='s10',linewidth=lw)
    plt.plot(w11[minval:maxval],I11[minval:maxval],label='s11',linewidth=lw)
    plt.plot(w12[minval:maxval],I12[minval:maxval],label='s12',linewidth=lw)
    plt.plot(w13[minval:maxval],I13[minval:maxval],label='s13',linewidth=lw)
    plt.plot(w14[minval:maxval],I14[minval:maxval],label='s14',linewidth=lw)
    plt.plot(w15[minval:maxval],I15[minval:maxval],label='s15',linewidth=lw)
    plt.plot(w16[minval:maxval],I16[minval:maxval],label='s16',linewidth=lw)
